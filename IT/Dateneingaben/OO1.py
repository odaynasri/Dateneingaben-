...
def open_kalender():
    kalender_popup= tk.Toplevel(window)
    ...
    d_bestätigen.grid(row=0, column=1, padx=10)

datum_button= tk.Button(benutzer_frame, text='Kalender öffen', command=open_kalender)
datum_button.grid(row=3, column=1, padx=10)
